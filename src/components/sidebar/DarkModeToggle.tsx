...
export default function DarkModeToggle(): JSX.Element {
  ...
  return (
    <div className="absolute bottom-6 flex items-center gap-x-3">
      ...
      <button
        onClick={toggleTheme}
        className="relative flex h-6 w-12 cursor-pointer items-center rounded-full bg-neutral-600 p-2"
        aria-label={isDark ? "toggle to light mode" : "toggle to dark mode"}
      >
        <span
          className={`block h-3 w-3 rounded-full bg-neutral-100 transition-all ${
