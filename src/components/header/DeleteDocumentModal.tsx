...
export default function DeleteDocumentModal({
  ...
  return (
    <div
      ...
      }  absolute left-0 top-0 z-50 h-screen w-screen bg-overlayTransparent dark:bg-lightOverlayTransparent`}
    ...
    >
      <div className="absolute left-1/2 top-1/2 w-[343px] -translate-x-1/2 -translate-y-1/2 rounded-md bg-neutral-100 p-6 dark:bg-neutral-1000">
        <span className="font-serif text-xl font-bold text-neutral-100 dark:text-neutral-100">
